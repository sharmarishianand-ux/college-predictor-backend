        ...
        if (!colleges || colleges.length === 0) {
          ...
          colleges.forEach((c, idx) => {
            ...
            body.push([
              ...
              { text: 'NA', style: 'tableCell', fillColor }, // 2024
              { text: 'NA', style: 'tableCell', fillColor }, // 2023
              { text: 'NA', style: 'tableCell', fillColor }, // Average
              { text: 'NA', style: 'tableCell', fillColor }  // Trend
            ]);
          });
        }
